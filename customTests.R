...
testa_igualdade_dataframes <- function(){
   ...
   try({
      ...
      tabela_controle <- read_excel(file.path(caminho_swirl(), "Analise_Colostrucional_no_R", "Despedida", "dados_collexdist.xlsx"))
   }, silent = TRUE)
   
   exists('dados_collexdist') && identical(dados_collexdist, tabela_controle)
}