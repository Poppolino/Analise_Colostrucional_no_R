...
testa_igualdade_dataframes <- function(){
   ...
   try({
      ...
      tabela_controle <- read_excel(file.path(caminho_swirl(), "Analise_Colostrucional_no_R", "Despedida", "dados_collexcovar.xlsx"))
   }, silent = TRUE)
   
   exists('dados_collexcovar') && identical(dados_collexcovar, tabela_controle)
}
